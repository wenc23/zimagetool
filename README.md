...
- **Bug 反馈**: 请详细描述问题现象、复现步骤和环境信息
- **功能建议**: 欢迎提出新功能建议和改进建议
- **代码贡献**: 请遵循 PEP 8 编码规范，编写清晰的注释和文档

### 🔄 更新日志

持续的功能增强和性能优化：

- **2026-02-26**: 优化 README 文档，增强用户体验说明
- **2026-01-03**: 真实进度条系统，支持跨页面进度跟踪
- **2026-01-01**: 从 Gradio 迁移到 Flask Web UI，性能提升 30%
...
7. **API 密钥安全**：请妥善保管 DeepSeek API 密钥，避免泄露
8. **备份重要数据**：定期备份生成的图片和配置文件
